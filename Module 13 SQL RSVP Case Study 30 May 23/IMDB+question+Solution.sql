...
FROM
(
	SELECT COUNT(*) AS Cnt,'ID' AS Column_Name FROM movie
	WHERE id is NULL
	Group by id
	UNION
	SELECT COUNT(*) AS Cnt,'title' AS Column_Name FROM movie
	WHERE title is NULL
	GROUP BY title
	UNION
	SELECT COUNT(*) AS Cnt,'year' AS Column_Name FROM movie
	WHERE year is NULL
	GROUP BY year
	UNION
	SELECT COUNT(*) AS Cnt,'date_published' AS Column_Name FROM movie
	WHERE date_published is NULL
	GROUP BY date_published
	UNION
	SELECT COUNT(*) AS Cnt,'duration' AS Column_Name FROM movie
	WHERE duration is NULL
	GROUP BY duration
	UNION
	SELECT COUNT(*) AS Cnt,'country' AS Column_Name FROM movie
	WHERE country is NULL
	UNION
	SELECT COUNT(*) AS Cnt,'worlwide_gross_income' AS Column_Name FROM movie
	WHERE worlwide_gross_income is NULL
	GROUP BY worlwide_gross_income
	UNION 
	SELECT COUNT(*) AS Cnt,'languages' AS Column_Name FROM movie
	WHERE languages is NULL
	GROUP BY languages
	UNION
	SELECT COUNT(*) AS Cnt,'product_company' AS Column_Name FROM movie
